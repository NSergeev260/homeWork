...
// товарах, сумме заказа и статусе.
//
// Реализация CRUD операций:
// Создайте CRUD операции для пользователей и их заказов
...
//
// Настройте их в соответствии с вашими потребностями (например,
// в представлении UserSummary отображать только базовую информацию о пользователе,
// а в UserDetails включать также детали заказов).
//
...
//
// Тестирование:
// Напишите модульные тесты для вашего кода, уделяя внимание
// различным представлениям JSON при использовании @JsonView.