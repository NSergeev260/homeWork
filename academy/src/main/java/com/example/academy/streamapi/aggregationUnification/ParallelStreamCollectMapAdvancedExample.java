package com.example.academy.streamapi.aggregationUnification;
...
public class ParallelStreamCollectMapAdvancedExample {
    public static void main(String[] args) {
        ...
        Map<String, Double> averageGradesByAllStuff = students.parallelStream()
        ...
        System.out.println("=== Average grades by stuff ===");
        averageGradesByAllStuff.forEach((subject, average) ->
