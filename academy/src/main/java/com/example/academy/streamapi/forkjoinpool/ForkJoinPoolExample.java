...
//  В конструкторе FactorialTask передайте число n,
//  факториал которого нужно вычислить.
//  В методе compute() разбейте задачу на подзадачи и
//  используйте fork() для их асинхронного выполнения.
//  Используйте join() для получения результатов подзадач и
//  комбинирования их для получения общего результата.
//  В основном методе создайте экземпляр FactorialTask с числом,
